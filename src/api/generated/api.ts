...
import type {
  ...
  AnswerResponse,
  Answers,
  AnswersControllerCreateAnomalyResolutionBody,
  ...
  AnswersControllerFindListParams,
  AnswersWithQuestion,
  ...
  ChecklistsControllerFindCheckListPaginatedByParamsParams,
  ...
  EmployeesControllerSendEmailParams,
  FindCompanySettings,
  GroupedCheckList,
  LoginDto,
  Question,
...
const employeesControllerSendEmail = (
    params: EmployeesControllerSendEmailParams,
 ) => {
      return customInstance<void>(
      {url: `http://localhost:3000/employees/send-email`, method: 'GET',
        params
    },
      );
    }
...
const checklistsControllerUpdateCheckListName = (
    updateChecklistDto: UpdateChecklistDto,
      ...
      return customInstance<CheckList>(
      {url: `http://localhost:3000/checklists`, method: 'PUT',
      headers: {'Content-Type': 'application/json', },
...
const checklistsControllerFindAll = (
      ...
      return customInstance<CheckListDto[]>(
      {url: `http://localhost:3000/checklists/all`, method: 'GET'
    },
      );
    }
  
const checklistsControllerFindCheckListPaginatedByParams = (
    params: ChecklistsControllerFindCheckListPaginatedByParamsParams,
 ) => {
      return customInstance<GroupedCheckList[]>(
      {url: `http://localhost:3000/checklists/checkListWithCompanies`, method: 'GET',
        params
    },
      );
    }
...
const checklistsControllerConnectCheckListToCompany = (
    batchConnectCompanyToChecklistDto: BatchConnectCompanyToChecklistDto[],
 ) => {
      return customInstance<unknown>(
      {url: `http://localhost:3000/checklists/connect-checklist-company`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
      data: batchConnectCompanyToChecklistDto
    },
      );
    }
...
const answersControllerFindList = (
    params?: AnswersControllerFindListParams,
 ) => {
...
if(answersControllerCreateForImageQuestionBody.employee_id !== undefined) {
 formData.append('employee_id', answersControllerCreateForImageQuestionBody.employee_id.toString())
 }
...
const answersControllerCreateAnomalyResolution = (
    answersControllerCreateAnomalyResolutionBody: AnswersControllerCreateAnomalyResolutionBody,
 ) => {const formData = new FormData();
if(answersControllerCreateAnomalyResolutionBody.image !== undefined) {
 formData.append('image', answersControllerCreateAnomalyResolutionBody.image)
 }
if(answersControllerCreateAnomalyResolutionBody.description !== undefined) {
 formData.append('description', answersControllerCreateAnomalyResolutionBody.description)
 }
if(answersControllerCreateAnomalyResolutionBody.answer_id !== undefined) {
 formData.append('answer_id', answersControllerCreateAnomalyResolutionBody.answer_id)
 }
...
export type EmployeesControllerSendEmailResult = NonNullable<Awaited<ReturnType<ReturnType<typeof getIndicadorOnlineAPI>['employeesControllerSendEmail']>>>
...
export type ChecklistsControllerFindCheckListPaginatedByParamsResult = NonNullable<Awaited<ReturnType<ReturnType<typeof getIndicadorOnlineAPI>['checklistsControllerFindCheckListPaginatedByParams']>>>
