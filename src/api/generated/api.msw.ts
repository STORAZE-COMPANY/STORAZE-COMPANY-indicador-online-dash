...
export const getAnswersControllerCreateResponseMock = (overrideResponse: Partial< Answers > = {}): Answers => ({id: faker.string.alpha(20), textAnswer: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), imageAnswer: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), question_id: faker.string.alpha(20), employee_id: faker.number.int({min: undefined, max: undefined}), anomalyStatus: faker.string.alpha(20), ...overrideResponse})
...
export const getAnswersControllerCreateForImageQuestionResponseMock = (overrideResponse: Partial< Answers > = {}): Answers => ({id: faker.string.alpha(20), textAnswer: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), imageAnswer: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), question_id: faker.string.alpha(20), employee_id: faker.number.int({min: undefined, max: undefined}), anomalyStatus: faker.string.alpha(20), ...overrideResponse})
...
export const getAnswersControllerCreateMockHandler = (overrideResponse?: Answers | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<Answers> | Answers)) => {
...
export const getAnswersControllerCreateForImageQuestionMockHandler = (overrideResponse?: Answers | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<Answers> | Answers)) => {
